...
An account can configure an Introbox for accepted messages to the Inbox from
message-from address without established reputation. This keeps messages from
unknown correspondents separate while messages from known correspondents
continue to arrive in their regular destination.
