...
export interface Settings {
	...
	WebmailTheme: string  // Webmail appearance. WebmailTheme: "" (classic, default) or "modern". WebmailScheme: "" (auto), "light", "dark", "hclight", "hcdark". WebmailAccent: "" (blue, default), "indigo", "teal", "graphite", or a "#rrggbb" colour.
	WebmailScheme: string
	WebmailAccent: string
	WebmailListScale: string  // Webmail typography for the modern theme. Sizes are CSS scale multipliers as strings: "" (default, 100%), e.g. "0.9" or "1.1". Element styles are "" (theme default), "normal", "bold", "italic", or "bolditalic".; Message-list text size.
	...
	WebmailUnreadStyle: string  // How unread messages are emphasized in the modern message list: "" (default, accent bar on the left), "bold", "barbold", "tint" (accent-tinted row), "dot".
